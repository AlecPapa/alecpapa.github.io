...
(function() {
    var data = {
        ...
        pieChart: [{
                color: 'red',
                description: '62%的調查參與者認為現時香港保護瀕危物種的措施不足（或未聽過有關瀕危物種保護的措施）。',
                title: 'flowers',
                value: 0.69
            },
            {
                color: 'blue',
                description: '有38%的調查參與者認為現時香港保護瀕危物種的措施較為有效，其中大部分所舉例子為公益廣告或動物保護組織所做出貢獻。',
                title: 'trains',
                value: 0.31
            }
        ]
        ...
        function drawDetailedInformation(data, element) {
            ...
            if ((bBox.x + bBox.width / 2) > 0) {
                infoContainer = detailedInfo.append('g')
                    ...
                    .attr(
                        'transform',
                        'translate(' + (width - infoWidth - 10) + ',' + (bBox.height + bBox.y) + ')'
                    );
                anchor = 'end';
                position = 'right';
            } else {
